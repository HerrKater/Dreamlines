...
{ 
    ...
    { 
        public Ship(Dreamlines.Domain.Model.Ship ship)
		{
            Id = ship.Id;
            Name = ship.Name;
            SalesUnitId = ship.SalesUnitId;
            Bookings = new List<Booking>();
            if (ship.Bookings != null)
            {
        ...
        /// <summary>
        /// Gets or Sets salesUnitId
        /// </summary>
        [DataMember(Name= "salesUnitId")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SalesUnitId: ").Append(SalesUnitId).Append("\n");
        ...
        public bool Equals(Ship other)
        {
            ...
            return 
                ...
                (
                    SalesUnitId == other.SalesUnitId ||
                    SalesUnitId != null &&
                    SalesUnitId.Equals(other.SalesUnitId)
                ) && 
                (
                    Name == other.Name ||
                    Name != null &&
                ...
                (
                    ...
                    Bookings != null &&
                    Bookings.SequenceEqual(other.Bookings)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (SalesUnitId != null)
                    hashCode = hashCode * 59 + SalesUnitId.GetHashCode();
                    if (Name != null)
                    hashCode = hashCode * 59 + Name.GetHashCode();
                    if (Bookings != null)
                    hashCode = hashCode * 59 + Bookings.GetHashCode();
                return hashCode;
            }
        }
